...
TRANSLATIONS["ru"].update(
    {
        "tab.dual_quotes": "Две биржи",
        "dual.title": "Dual-exchange quotes runtime",
        "dual.subtitle": "Держит один perpetual Binance и один perpetual Bitget, получает live L1 quotes и считает spread без ордеров.",
        "dual.market_type": "Фьючерз бесср.",
        "dual.price_mode": "Top-of-book",
        "dual.left_placeholder": "Выберите Binance инструмент",
        "dual.right_placeholder": "Выберите Bitget инструмент",
        "dual.start": "Старт",
        "dual.stop": "Стоп",
        "dual.send_both": "Send Both Legs",
        "dual.status": "Статус runtime",
        "dual.spread_state": "Spread state",
        "dual.left_bid": "Binance bid",
        "dual.left_ask": "Binance ask",
        "dual.right_bid": "Bitget bid",
        "dual.right_ask": "Bitget ask",
        "dual.left_age": "Age Binance",
        "dual.right_age": "Age Bitget",
        "dual.edge_1": "edge_1",
        "dual.edge_2": "edge_2",
        "dual.left_side": "Левая side",
        "dual.right_side": "Правая side",
        "dual.left_qty": "Левая qty",
        "dual.right_qty": "Правая qty",
        "dual.left_price_mode": "Левая цена",
        "dual.right_price_mode": "Правая цена",
        "dual.left_order_status": "Статус левой ноги",
        "dual.right_order_status": "Статус правой ноги",
        "dual.left_ack_latency": "Ack левой",
        "dual.right_ack_latency": "Ack правой",
        "dual.left_fill_latency": "Fill левой",
        "dual.right_fill_latency": "Fill правой",
        "dual.left_filled_qty": "Filled левой",
        "dual.right_filled_qty": "Filled правой",
        "dual.exec_status": "Dual exec status",
        "dual.entry_threshold": "Порог входа",
        "dual.max_quote_age": "Макс. age quote",
        "dual.max_quote_skew": "Макс. skew quote",
        "dual.active_edge": "Сработавший edge",
        "dual.entry_direction": "Направление входа",
        "dual.entry_block_reason": "Причина блокировки",
        "dual.entry_count": "Кол-во входов",
        "dual.last_entry_ts": "Последний entry ts",
        "dual.start_spread_entry": "Start Spread Entry",
        "dual.stop_spread_entry": "Stop Spread Entry",
        "dual.error.select_both": "Сначала выберите оба инструмента.",
        "dual.error.no_credentials": "Нет подключённых карточек Binance и Bitget с ключами.",
        "dual.log.starting": "Старт dual runtime: Binance={left_symbol} · Bitget={right_symbol}",
        "dual.log.starting_spread_entry": "Старт spread-entry runtime: Binance={left_symbol} · Bitget={right_symbol} · threshold={threshold}",
        "dual.log.stopping": "Остановка dual runtime",
        "dual.log.send_both": "Send Both Legs: left={left_side} {left_qty} · right={right_side} {right_qty}",
    }
)

TRANSLATIONS["en"].update(
    {
        "tab.dual_quotes": "Dual Quotes",
        "dual.title": "Dual-exchange quotes runtime",
        "dual.subtitle": "Keeps one Binance perpetual and one Bitget perpetual, streams live L1 quotes, and calculates spread without orders.",
        "dual.market_type": "Futures Perpetual",
        "dual.price_mode": "Top-of-book",
        "dual.left_placeholder": "Select Binance instrument",
        "dual.right_placeholder": "Select Bitget instrument",
        "dual.start": "Start",
        "dual.stop": "Stop",
        "dual.send_both": "Send Both Legs",
        "dual.status": "Runtime status",
        "dual.spread_state": "Spread state",
        "dual.left_bid": "Binance bid",
        "dual.left_ask": "Binance ask",
        "dual.right_bid": "Bitget bid",
        "dual.right_ask": "Bitget ask",
        "dual.left_age": "Binance age",
        "dual.right_age": "Bitget age",
        "dual.edge_1": "edge_1",
        "dual.edge_2": "edge_2",
        "dual.left_side": "Left side",
        "dual.right_side": "Right side",
        "dual.left_qty": "Left qty",
        "dual.right_qty": "Right qty",
        "dual.left_price_mode": "Left price",
        "dual.right_price_mode": "Right price",
        "dual.left_order_status": "Left order status",
        "dual.right_order_status": "Right order status",
        "dual.left_ack_latency": "Left ack",
        "dual.right_ack_latency": "Right ack",
        "dual.left_fill_latency": "Left fill",
        "dual.right_fill_latency": "Right fill",
        "dual.left_filled_qty": "Left filled",
        "dual.right_filled_qty": "Right filled",
        "dual.exec_status": "Dual exec status",
        "dual.entry_threshold": "Entry threshold",
        "dual.max_quote_age": "Max quote age",
        "dual.max_quote_skew": "Max quote skew",
        "dual.active_edge": "Active edge",
        "dual.entry_direction": "Entry direction",
        "dual.entry_block_reason": "Entry block reason",
        "dual.entry_count": "Entry count",
        "dual.last_entry_ts": "Last entry ts",
        "dual.start_spread_entry": "Start Spread Entry",
        "dual.stop_spread_entry": "Stop Spread Entry",
        "dual.error.select_both": "Select both instruments first.",
        "dual.error.no_credentials": "No connected Binance and Bitget cards with credentials.",
        "dual.log.starting": "Starting dual runtime: Binance={left_symbol} · Bitget={right_symbol}",
        "dual.log.starting_spread_entry": "Starting spread-entry runtime: Binance={left_symbol} · Bitget={right_symbol} · threshold={threshold}",
        "dual.log.stopping": "Stopping dual runtime",
        "dual.log.send_both": "Send Both Legs: left={left_side} {left_qty} · right={right_side} {right_qty}",
    }
)
