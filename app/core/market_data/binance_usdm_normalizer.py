...
class BinanceUsdmQuoteNormalizer(QuoteNormalizer):
    """Normalizes Binance USD-M bookTicker payloads into QuoteL1."""

    def normalize_l1(self, instrument: InstrumentId, payload: dict[str, Any], ts_local: int) -> QuoteL1:
        ts_exchange = int(payload.get("T") or payload.get("E") or 0)
        return QuoteL1(
