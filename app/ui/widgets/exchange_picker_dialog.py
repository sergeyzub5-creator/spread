...
from app.ui.exchange_catalog import EXCHANGE_ORDER, get_exchange_meta
...
class ExchangePickerDialog(QDialog):
    def __init__(self, exchange_codes: list[str] | None = None, parent=None) -> None:
        super().__init__(parent)
        self.selected_code: str | None = None
        self._exchange_codes = list(exchange_codes or EXCHANGE_ORDER)
    ...
    def _build_ui(self) -> None:
        ...
        for code in self._exchange_codes:
